...
@section('title', 'Nuevo Plan - MecxiHub')
@section('header-title', 'Crear Nuevo Plan')
@section('header-subtitle', 'Añade un nuevo plan al catálogo')
...
@section('content')
    ...
    <form action="{{ route('gestor.planes.store') }}" method="POST">
        @csrf
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
                        ...
                        @php
                            ...
                            $tiposSeleccionados = old('tipos_usuario', []);
                        @endphp
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" id="nombre" name="nombre" value="{{ old('nombre') }}" required
                                ...
                                class="w-full px-4 py-2.5 rounded-xl border border-gray-200 focus:outline-none focus:border-brand-blue text-sm @error('nombre') border-red-400 @enderror">
                        </div>
                        ...
                        <div>
                            ...
                            <textarea id="descripcion" name="descripcion" rows="3" placeholder="Describe brevemente qué incluye este plan..."
                                class="w-full px-4 py-2.5 rounded-xl border border-gray-200 focus:outline-none focus:border-brand-blue text-sm">{{ old('descripcion') }}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
                    ...
                    <div id="caracteristicas-container" class="space-y-2">
                        @php
                            $oldCars = old('caracteristicas', ['']);
                        @endphp
                        @foreach ($oldCars as $i => $car)
                    ...
                    <p class="text-xs text-gray-400 mt-2">Puedes añadir las características que incluye el plan.</p>
                </div>
            ...
            <div class="space-y-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="number" min="1" id="duracion_dias" name="duracion_dias"
                                value="{{ old('duracion_dias', 30) }}" required
                                class="w-full px-4 py-2.5 rounded-xl border border-gray-200 focus:outline-none focus:border-brand-blue text-sm">
                        </div>
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-4 flex flex-col gap-2">
                    <button type="submit"
                        ...
                        <i class="fa-solid fa-floppy-disk mr-2"></i> Guardar Plan
                    </button>
